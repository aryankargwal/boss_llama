...
st.sidebar.title("Boss Llama 🦙")
st.sidebar.subheader("Welcome to Boss Llama, an AI bot to simulate interviews, which aids in evaluation and improving answers. Please add your Job Description, Number of Questions, Difficulty, and API Key to start the conversation.")
